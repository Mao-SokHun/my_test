...
> **Convention (team):** [`CONVENTION_GUIDE.md`](./CONVENTION_GUIDE.md) — file names, comments, folders, require paths  
...
> **Paths in this doc may show old names** (`mentorsController.js`, `routes/v1/mentors.js`). Use current layout: `controllers/mentor_system/mentors-controller.js`, `routes/v1/mentor_system/mentors.js`, `utils/mentor_system/api-response.js`.
