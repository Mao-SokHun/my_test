// ============= Start mentor mapper =============
// Backend snake_case → UI teacher object (name, subjects)
// Used after fetchMentorById and searchMentors items
// ................................................

// Start mapMentorToTeacher
// ................................................
export function mapMentorToTeacher(mentor) {
  ...
  const subjects = skills
    .map((mentorSkill) => mentorSkill.SubSkill?.skill_name || mentorSkill.subSkill?.skill_name)
    .filter(Boolean)
...
// End mapMentorToTeacher
// ................................................

// Start mapTeacherFormToMentorPayload — EditProfile → PUT /mentors/:userId
// ................................................
...
// End mapTeacherFormToMentorPayload
// ................................................
